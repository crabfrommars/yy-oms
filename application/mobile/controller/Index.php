...
class Index extends Base
{
    ...
    public function getProductInfo()
    {
        ...
        if ($proInfo){
            ...
            // 更改入库日期的时间格式
            if ($proInfo->storage_date){
                $proInfo->storage_date=date("Y-m-d",strtotime($proInfo->storage_date));
            }
            ...
            if ($orderInfo){
                ...
                array_push($srcArr,'https://oms.yuyangking.com/static/notFound.png');
                $res=['code'=>0,'msg'=>'查询成功','proInfo'=>$proInfo,'orderInfo'=>null,'imgSrc'=>$srcArr[0],'srcArr'=>$srcArr];
            }
